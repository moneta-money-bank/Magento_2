...
namespace Moneta\Payment\Controller\Gateway;
...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (!isset($additionalInformation['originalMerchantTxId']) || $additionalInformation['originalMerchantTxId'] == '') {
            $this->_redirect($urlInterface->getUrl('moneta_payment/standard/cancel'));
            return;
        }
        ...
        $url = $urlInterface->getUrl('moneta_payment/standard/cancel');
