...
namespace Moneta\Payment\Model;


use Moneta\Payment\Model\Config\Source\Brand;
use Moneta\Payment\Helper\Helper;
use Moneta\Payment\Model\Config\Source\NewOrderPaymentActions;
...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod implements GatewayInterface
{
    ...
    /**
     * @var \Moneta\Payment\Helper\Helper
     */
    private $_helper;
    /**
    ...
    public function getCheckoutRedirectUrl()
    {
       ...
       if ($displayMode === DisplayMode::DISPLAY_MODE_IFRAME) {
           $redirectUrl = 'moneta/hosted/iframe';
        } else {
            $redirectUrl = 'moneta/hosted/redirect';
        }
